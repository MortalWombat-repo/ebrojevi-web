...
const HeroSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[65vh] flex items-center justify-center px-6 md:px-8 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
        ...
        >
          <Button
            size="lg"
            variant="outline"
            className="border-primary/20 hover:bg-primary/10 w-56 flex items-center justify-center"
          >
          ...
          >
            <div
              ...
              } w-full h-32 flex flex-col items-center justify-center`} // Rectangular shape
            >
              <input {...getInputProps()} />
              <FontAwesomeIcon
                icon={faImage}
